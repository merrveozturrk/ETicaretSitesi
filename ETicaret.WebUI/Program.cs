...
builder.Services.AddDbContext<ApplicationContext>(option => option.UseSqlServer("Server=203-UGURCAN;Database=ETicaret203;Integrated Security=true"));
...
new EmailSender("smtp.office365.com", 587, true, "merveozturk1234567890@hotmail.com", "Ozturk.6134")
);
